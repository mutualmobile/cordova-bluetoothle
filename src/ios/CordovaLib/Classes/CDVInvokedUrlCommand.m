...
- (NSString *)description {
    ...
    [desc appendString:[NSString stringWithFormat:@"arguments: %@\n", _arguments]];
    [desc appendString:[NSString stringWithFormat:@"callbackId: %@\n", _callbackId]];
    [desc appendString:[NSString stringWithFormat:@"className: %@\n", _className]];
    [desc appendString:[NSString stringWithFormat:@"methodName: %@\n", _methodName]];
    return desc;
}
